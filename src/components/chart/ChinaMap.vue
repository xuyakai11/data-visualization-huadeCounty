<template>
  <div class="echart" ref="echart" style="width: 8rem;height: 5.95rem">
  </div>
</template>
<script lang="ts">
  ...
  drawChart (geoJson: any) {
		...
		myChart.setOption({
			...
			geo: {
				...
				itemStyle: {
					normal: {
						areaColor: 'rgba(0,100,188,.6)',
						borderColor: 'rgba(0,100,188,.8)'
					},
					emphasis: {
						areaColor: 'rgba(0,100,188,.8)'
					}
				}
			},
			series: [{
